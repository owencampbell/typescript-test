...
describe("Checksum", () => {
    it("value at position 1 is 1", () => {
        ...
        expect(checksum.evaluate(spreadsheet)).toBe(8);
    });

    it("checksum value at position 2 is 1", () => {
        const checksum = new Checksum();
        const spreadsheet = [
            [5, 1, 9, 5],
            [7, 5, 3],
        ...
        expect(checksum.evaluate(spreadsheet)).toBe(18);
    });
    ...
    it(" value at position 10 is 34", () => {
        ...
        expect(checksum.evaluate(spreadsheet)).toBe(53978);
    });
});